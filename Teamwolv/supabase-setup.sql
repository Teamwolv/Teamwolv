-- Team Wolv Database Setup for Production
...
INSERT INTO events (title, description, date, location, featured, image_url) VALUES
('Team Wolv Launch Party', 'Join us for the official launch of Team Wolv platform', '2024-12-15T18:00:00Z', 'Virtual Event', true, '/placeholder.svg?height=240&width=460&query=event image'),
('Tech Meetup 2024', 'Connect with fellow developers and tech enthusiasts', '2024-12-20T19:00:00Z', 'Downtown Conference Center', false, '/placeholder.svg?height=240&width=460&query=event image'),
('Creative Workshop', 'Unleash your creativity in our hands-on workshop', '2024-12-25T14:00:00Z', 'Community Arts Center', true, '/placeholder.svg?height=240&width=460&query=event image')
ON CONFLICT DO NOTHING;

-- 15. Create admin user function
